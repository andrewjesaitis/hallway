"""
Django settings for hallway project.
...
SECRET_KEY = 'o-x%=2^rq3ruwu1d^@1=b6hz2v(z39li!2)#ubf-m8f!jx^cl!'
...
WSGI_APPLICATION = 'hallway.wsgi.application'
...
ACCOUNT_EMAIL_SUBJECT_PREFIX='[Hallway]'
